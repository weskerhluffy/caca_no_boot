...
public class UserController {
	...
	public ModelAndView getUsersView() {
		...
		User[] combinedPersonObjs = { new User(10L, "uno", "unop", "unoe"), new User(11L, "dos", "dosp", "dose") };
	...
	public @ResponseBody List<User> getUsersRest() {
		User[] combinedPersonObjs = { new User(20L, "uno", "unop", "unoe"), new User(21L, "dos", "dosp", "dose") };
